    ...
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        ...
        <label class="btn btn-info btn-aspectRatio" onclick="changeAspectRatio(this, null)">
          {{ translate('lfm.btn-crop-free') }}
        </label>
      </div>
      <br>
      <br>
      <div class="btn-group clearfix">
        <button class="btn btn-secondary" onclick="loadItems()">{{ translate('lfm.btn-cancel') }}</button>
        <button class="btn btn-warning" onclick="performCropNew()">{{ translate('lfm.btn-copy-crop') }}</button>
        <button class="btn btn-primary" onclick="performCrop()">{{ translate('lfm.btn-crop') }}</button>
      </div>
      <form id='cropForm'>
