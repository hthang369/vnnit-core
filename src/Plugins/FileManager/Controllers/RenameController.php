...
use Vnnit\Core\Plugins\FileManager\Events\FolderIsRenaming;
use Vnnit\Core\Plugins\FileManager\Events\FolderWasRenamed;
use Vnnit\Core\Plugins\FileManager\Events\ImageIsRenaming;
use Vnnit\Core\Plugins\FileManager\Events\ImageWasRenamed;
...
class RenameController extends LfmController
{
    public function getRename()
    {
        ...
        if (config('file-manager.alphanumeric_directory') && preg_match('/[^\w-]/i', $new_name)) {
