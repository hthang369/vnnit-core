...
use Vnnit\Core\Plugins\FileManager\LfmPath;
...
class LfmController extends Controller
{
    ...
    protected function view($viewName)
    {
        ...
        return view("$prefix::components.file-manager.$viewName");
    }
    ...
    public function getErrors()
    {
        ...
        if (! extension_loaded('gd') && ! extension_loaded('imagick')) {
            array_push($arr_errors, translate('lfm.message-extension_not_found'));
        }
        ...
        $mine_config_key = 'file-manager.folder_categories.'
    ...
    {
        $overrides = config('file-manager.php_ini_overrides', []);
